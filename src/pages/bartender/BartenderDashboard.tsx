...
import { Wine, Clock, CheckCircle, AlertCircle, GlassWater } from 'lucide-react';
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500">Gestiona los pedidos de bebidas</p>
          </div>
          <Button 
            variant="outline" 
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">{pedidosPendientesBar.length}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">{pedidosPreparandoBar.length}</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">
                    {pedidosBar.filter(p => p.estado === 'LISTO').length}
                  </p>
                </div>
        ...
        <div className="flex gap-2">
          ...
          >
            Pendientes ({pedidosPendientesBar.length})
          </Button>
          <Button
